        ...
        <main className="mt-44 w-full max-w-7xl font-cafe24 mx-auto flex justify-center items-center">
          <div className="text-center">
            ...
            >
              ...
              <textarea
                className="w-full p-4 border rounded-lg h-32 text-lg focus:outline-none focus:ring-2 focus:ring-white"
                placeholder="당신의 조각을 남겨보세요..."
                value={text}
                onChange={(e) => setText(e.target.value)}
              />
              <input
                className="w-full p-4 border rounded-lg text-lg mt-4 focus:outline-none focus:ring-2 focus:ring-white"
              ...
              <div className="w-full flex justify-between mt-6">
                ...
                <button
                  className={`px-6 py-2 rounded-lg text-white transition hover:border-transparent hover:scale-105 ${
                    loading ? "bg-gray-400" : "bg-[#6A0DAD] hover:bg-[#7A3C98]"
                  }`}
                  style={{
