            ...
            >
              ...
              {preview && (
                <audio
                  src={preview}
                  controls
                  className="mt-4 w-full rounded-md shadow-md border border-gray-300"
                />
              )}
              <div className="w-full flex justify-between mt-6">
                <button
                  className="px-6 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500 border transition hover:border-transparent hover:scale-105"
                ...
                <button
                  className="px-6 py-2 rounded-lg text-white transition hover:border-transparent border hover:scale-105 bg-[#6A0DAD] hover:bg-[#7A3C98]"
