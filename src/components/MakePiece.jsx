  ...
  return (
    <div className="min-h-screen bg-[#F7F3E5] flex flex-col items-center">
      ...
      <main className="mt-20 w-full max-w-6xl">
        <h2 className="text-5xl font-handwriting text-left text-[#6B4F35]">
          당신의 이야기를 한 조각씩 채워보세요.
        </h2>
        <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
          {/* 1 */}
          <div 
            className="p-6 bg-[#EADDC5] rounded-lg cursor-pointer transition hover:bg-[#B99C75] font-handwriting text-center"
            onClick={() => navigate("/writeTextPiece")}
          >
            <img src="/text_piece.png" alt="글 조각" className="w-full h-48 object-cover rounded-md mb-4" />
            <h3 className="text-4xl font-semibold">나만의 글 조각 작성</h3>
          ...
          >
            ...
            <h3 className="text-4xl font-semibold">순간의 사진 조각 작성</h3>
            <p className="text-2xl text-gray-700 mt-2">
          ...
          >
            ...
            <h3 className="text-4xl font-semibold">공유 동영상 조각 작성</h3>
            <p className="text-2xl text-gray-700 mt-2">
          ...
          >
            ...
            <h3 className="text-4xl font-semibold">기억할 음성 조각 작성</h3>
            <p className="text-2xl text-gray-700 mt-2">
